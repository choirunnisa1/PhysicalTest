...
public class TableViewAdapter extends RecyclerView.Adapter {
    ...
    private List agiltylist;

    public TableViewAdapter(List agiltylist) {
        this.agiltylist = agiltylist;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            rowViewHolder.txtMovieName.setText("Nama");
            rowViewHolder.txtYear.setText("Prestasi Putra (detik)");
            rowViewHolder.txtCost.setText("Prestasi Putri (detik)");
        } else {

            AgiltyModel agiltyModel = (AgiltyModel) agiltylist.get(rowPos - 1);
